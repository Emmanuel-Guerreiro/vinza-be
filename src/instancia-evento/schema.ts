...
export const createInstanciaEventoSchema = z.object({
  ...
  estadoId: z.number().positive('El ID del estado debe ser un número positivo').optional(),
});
...
export const updateInstanciaEventoSchema = z.object({
  ...
  eventoId: z.number({
    invalid_type_error: 'El ID del evento debe ser un número válido',
  }).positive('El ID del evento debe ser un número positivo').optional(),
  recurrenciaEventoId: z.number({
    invalid_type_error: 'El ID de la recurrencia debe ser un número válido',
  }).positive('El ID de la recurrencia debe ser un número positivo').optional(),
  estadoId: z.number().positive('El ID del estado debe ser un número positivo').optional(),
});
...
export const findAllParamsSchema = paginationAndOrderSchema(
  ...
  recurrenciaEventoId: z.coerce.number().positive('El ID de la recurrencia debe ser un número positivo').optional(),
  estadoId: z.coerce.number().positive('El ID del estado debe ser un número positivo').optional(),
  ...
  categoriaEventoId: z.coerce.number().positive('El ID de la categoría debe ser un número positivo').optional(),
  sucursalId: z.coerce.number().positive('El ID de la sucursal debe ser un número positivo').optional(),
  precioMaximo: z.coerce.number().min(0, 'El precio máximo debe ser un número mayor o igual a 0').optional(),
  precioMinimo: z.coerce.number().min(0, 'El precio mínimo debe ser un número mayor o igual a 0').optional(),
}).refine((data) => {
